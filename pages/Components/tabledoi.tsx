...
function CustomizedTablesdoi() {
  ...
  return (
    <table className={styles.contenttable}>
      <thead>
        <tr>
          <th className={styles.tablename}>Partners</th>
        </tr>
        <tr>
      ...
      <tbody>
        {companyProfile.personal?.PRT?.map((personalinfo: any, k: number) => (
          <tr key={k}>
...
export default CustomizedTablesdoi;
